...
{
    class PurchaseOKMessageComposer : IMessageComposer
    {
        private CatalogueItem _item;
        private readonly int _durationRequirement;

        public PurchaseOKMessageComposer(CatalogueItem offer, int durationRequirement = -1)
        {
            this._item = offer;
            this._durationRequirement = durationRequirement;
        }

        public override void Write()
        {
            SerialiseOffer(this, _item);
        }

...
{
    class GetGuestRoomResultComposer : IMessageComposer
    {
        public RoomData room;
        private bool isLoading;
        private bool checkEntry;

        public GetGuestRoomResultComposer(RoomData roomData)
        {
            this.room = roomData;
            this.isLoading = true;
        ...
        public GetGuestRoomResultComposer(RoomData roomData, bool isLoading, bool checkEntry)
        {
            this.room = roomData;

...
{
    class FriendListUpdateComposer : IMessageComposer
    {
        private List<MessengerCategoryData> categories;
        private List<MessengerUpdate> updates;

        public FriendListUpdateComposer(List<MessengerCategoryData> categories, List<MessengerUpdate> updates)
        {
        ...
        public override int HeaderId => 13;
    }
}
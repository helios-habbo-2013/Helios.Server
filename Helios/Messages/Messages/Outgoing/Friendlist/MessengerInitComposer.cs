...
{
    class MessengerInitComposer : IMessageComposer
    {
        ...
        public MessengerInitComposer(int maxNormalFriends, int maxHCFriends, int maxVIPFriends, List<MessengerCategoryData> categories, List<MessengerUser> friends)
        {
